...
- ROCm profiles own ROCm versions, wheel indexes, target lists, and whether RCCL is rebuilt. Keep ROCm installers free of hardcoded package indexes if it can be avoided.
